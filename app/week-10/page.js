        ...
        <main className="min-h-screen bg-blue-200">
            {user ? (
                ...
                <div className="max-w-md mx-auto p-8">
                    ...
                    <Link href="./week-10/shopping-list" className="mt-1 p-1 block w-full rounded-md text-black bg-gray-100 focus:bg-white hover:bg-blue-500 text-center">shopping-list Page</Link><br />
